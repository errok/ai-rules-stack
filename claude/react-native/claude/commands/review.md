...
Review **the full uncommitted diff** (or whatever diff the user explicitly scopes), check it against **repo conventions** (`.claude/rules/`, project architecture), and **suggest changes only when genuinely useful**.  
